...
**Purpose**: Multi-model audit loop — Claude plans/codes, GPT-5.4 audits, Gemini 3.1 Pro does independent final review.
...
- **gemini-review.mjs**: Single-call final review after Claude-GPT convergence. Receives full audit transcript. Detects bias, false consensus, missed issues. Uses Gemini 3.1 Pro with native JSON Schema (converted from Zod).
...
| `GEMINI_API_KEY` | No | — | Gemini final review (Step 6.5 skipped if absent) |
