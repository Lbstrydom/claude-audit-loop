...
import {
  refreshModelCatalog, resolveModel, resolveXaiCreds, resolveAlibabaCreds,
...
// `SHADOW_PROVIDER_SPECS` + `shadowModelMatchesFamily` moved to
// `scripts/lib/final-review/provider-specs.mjs` on 2026-08-18 so the credential
// table has ONE home: the pinned-revision fixture preflights the same keys before
// a spend-bearing run, and a second spelling would pass while an arm skipped.
// See that module's fileoverview. Both stay in `_internals` below, unchanged.
/**
