...
const REPOS = [
  {
    ...
    files: [...CORE_SCRIPTS, ...LEARNING_SCRIPTS, ...DEBT_SCRIPTS, ...SKILL_FILES, ...COPILOT_PROMPT_FILES, ...EDITOR_FILES],
  },
  {
    name: 'ai-organiser',
    alias: 'ai',
    ...
    files: [...CORE_SCRIPTS, ...LEARNING_SCRIPTS, ...SKILL_FILES, ...COPILOT_PROMPT_FILES, ...EDITOR_FILES],
  },
];
